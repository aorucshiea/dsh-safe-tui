...
async function runREPL(ctx, initialSessionId) {
  ...
  /list                 alias of /sessions (use /list all for every session)
...
`);
    ...
    if (input === "/sessions" || input === "/list" || input === "/resume") {
      try {
    ...
    if (input === "/sessions all" || input === "/list all" || input === "/resume all") {
      try {
...
async function runTUI(ctx, initialSessionId) {
  ...
  const tui = new TUI({
    ...
    onCommandSelect: async (command) => {
      ...
      if (base === "/sessions" || base === "/list" || base === "/resume") {
...
TUI commands:
  /sessions /sessions all /list /list all /resume <id> /new /preset /preset <id>
